  ...
  scenarios: {
    shufflenet_test: {
      ...
      stages: [
        ...
        { duration: '105s', target: 50 },
        { duration: '105s', target: 0 },
      ],
    ...
    paddle_test: {
      ...
      //duration: '5m',
      stages: [
        { target: 130, duration: '90s' }, // go from 50 to 200 iters/s in the first 30 seconds
        { target: 200, duration: '105s' }, // hold at 200 iters/s for 3.5 minutes
        { target: 0, duration: '105s' }, // ramp down back to 0 iters/s over the last 30 second
      ],
